...
.pagination {
  ...
  .action {
    @apply rounded-md bg-slate-100 p-1 font-medium text-slate-700 shadow-md hover:bg-slate-200 disabled:text-slate-400 hover:disabled:bg-slate-100;
  }
  .page {
    @apply rounded-md bg-slate-100 p-4 font-medium text-slate-700 shadow-md hover:bg-slate-200;
    &.active {
      @apply bg-red-700 text-slate-100 hover:bg-red-600;
    }
  }
}
</style>
